# AGENTS.md: Christopher Robin Design Portfolio Site

Project instructions for Codex sessions on the Christopher Robin Design portfolio site. Read this file in full before touching the repo.

---

## Project instruction reference

Codex Project "CRD Website" governs session behaviour, tone, working assumptions and brief writing. This file governs codebase architecture and implementation conventions. If the two ever conflict, this file wins for code-related decisions and the Codex Project instructions win for process and communication style.
...
**Launch scope, confirmed in repo documentation:**

| Project | Client | Notes |
|---|---|---|
| Uncut | LoveLife | Real commissioned editorial work, not spec or concept. Credit LoveLife as client in copy. |
| Checkers | To be confirmed in project data | Retail marketing, thin asset set. |
| Playboy SA | To be confirmed in project data | Editorial portfolio work. |
| Leisure Boating | To be confirmed in project data | Asset currently includes 3D mockup material. Flat cover still desirable. |
| Kruger Magazine | To be confirmed in project data | Issue 29. Source and spread handling are documented in `docs/known-issues.md`. |

**Scope history note:** CRD as a studio-identity project was previously removed from the launch `/work` grid and detail route. Do not reintroduce it without a fresh explicit decision from Christopher.

**Deferred to post-launch unless explicitly re-scoped:** AgriProbe, Real Estate Investor, CaravanSA, the 2010 print advertising cluster, KWV and any experimental tools.
...
## 8. Standing instructions for Codex sessions
